...
export class SystemConfigService {
  ...
  readonly phaseConfig: Record<string, PhaseConfig> = {
    ...
    FOLLICULAR: {
      color: '#66BB6A',
      lightColor: '#E8F5E9',
      darkColor: 'rgba(102,187,106,0.18)',
      days: '6-13',
      icon: '🌱',
    },
    OVULATION: {
      color: '#42A5F5',
      lightColor: '#E3F2FD',
      darkColor: 'rgba(66,165,245,0.18)',
      days: '14',
      icon: '✨',
    },
    LUTEAL_EARLY: {
      color: '#FFA726',
      lightColor: '#FFF3E0',
      darkColor: 'rgba(255,167,38,0.18)',
      days: '15-21',
      icon: '🌙',
    },
    LUTEAL_LATE: {
      color: '#FF7043',
      lightColor: '#FBE9E7',
      darkColor: 'rgba(255,112,67,0.18)',
      days: '22-28',
      icon: '⚡',
    },
  };
  ...
  getGlucoseStatusColor(status: string, isDark: boolean): string {
    ...
    if (!pair) return isDark ? '#97C0BE' : '#546E7A';
